...
public class StatusResponseType implements org.apache.axis2.databinding.ADBBean
{
    ...
    public void setMonitorReason(java.lang.String param)
    {
        ...
        if (param != null)
        {
            ...
            localMonitorReasonTracker = true;
        }
        else
        {
            localMonitorReasonTracker = false;
    ...
    public void setMaintenanceReason(java.lang.String param)
    {
        ...
        {
            // update the setting tracker
            localMaintenanceReasonTracker = true;
        }
        else
        {
            localMaintenanceReasonTracker = false;
    ...
    public void setSessionUser(java.lang.String param)
    {
        ...
        {
            // update the setting tracker
            localSessionUserTracker = true;
        }
        else
        {
            localSessionUserTracker = false;
    ...
    public void setSlaveUsers(java.lang.String[] param)
    {
        ...
        validateSlaveUsers(param);

        if (param != null)
        {
            // update the setting tracker
            localSlaveUsersTracker = true;
        }
        else
        {
            localSlaveUsersTracker = false;
    ...
    {
        if (localSlaveUsers == null)
        {
            localSlaveUsers = new java.lang.String[] {};
        }

        // update the setting tracker
        localSlaveUsersTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSlaveUsers);
        list.add(param);
            ...
            final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
    {
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName)
        {
            ...
            {
                StatusResponseType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
    {
        ...
        if (serializeType)
        {
            ...
            {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "StatusResponseType",
                        xmlWriter);
            }
        ...
        else
        {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localIsMonitorFailed));
        }

        xmlWriter.writeEndElement();
        if (localMonitorReasonTracker)
        {
            namespace = "";
            if (!namespace.equals(""))
            {
            ...
            else
            {
                ...
                xmlWriter.writeCharacters(localMonitorReason);
        ...
        {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localIsInMaintenance));
        }

        xmlWriter.writeEndElement();
        if (localMaintenanceReasonTracker)
        {
            namespace = "";
            if (!namespace.equals(""))
            {
            ...
            if (localMaintenanceReason == null)
            {
                // write the nil attribute
            ...
            else
            {
                ...
                xmlWriter.writeCharacters(localMaintenanceReason);
        ...
        {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localIsInSession));
        }

        xmlWriter.writeEndElement();
        if (localSessionUserTracker)
        {
            namespace = "";
            if (!namespace.equals(""))
            {
            ...
            else
            {
                ...
                xmlWriter.writeCharacters(localSessionUser);

            }

            xmlWriter.writeEndElement();
        }
        if (localSlaveUsersTracker)
        {
            if (localSlaveUsers != null)
            {
                namespace = "";
                ...
                for (int i = 0; i < localSlaveUsers.length; i++)
                {

                    if (localSlaveUsers[i] != null)
                    {
                        ...
                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localSlaveUsers[i]));
            ...
            throws org.apache.axis2.databinding.ADBException
    {
        ...
        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsMonitorFailed));
        if (localMonitorReasonTracker)
        {
            ...
            if (localMonitorReason != null)
            {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMonitorReason));
            }
            else
            {
                throw new org.apache.axis2.databinding.ADBException("monitorReason cannot be null!!");
        ...
        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsInMaintenance));
        if (localMaintenanceReasonTracker)
        {
            ...
            if (localMaintenanceReason != null)
            {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(localMaintenanceReason));
            }
            else
            {
                throw new org.apache.axis2.databinding.ADBException("maintenanceReason cannot be null!!");
        ...
        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsInSession));
        if (localSessionUserTracker)
        {
            ...
            if (localSessionUser != null)
            {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSessionUser));
            }
            else
            {
                throw new org.apache.axis2.databinding.ADBException("sessionUser cannot be null!!");

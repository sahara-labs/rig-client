/**
 * NotificationRequestType.java This file was auto-generated from WSDL by the
...
/**
 * NotificationRequestType bean class
 */

public class NotificationRequestType extends au.edu.uts.eng.remotelabs.rigclient.protocol.types.AuthRequiredRequestType
        implements org.apache.axis2.databinding.ADBBean
{
    /*
     * This type was generated from the piece of schema that had name =
     * NotificationRequestType Namespace URI =
    ...
    public static class Factory
    {
         ...
         * outer element
         */
        public static NotificationRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
        {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if (fullTypeName != null)
                    {
                        ...
                        if (!"NotificationRequestType".equals(type))
                        {
                            ...
                            return (NotificationRequestType) au.edu.uts.eng.remotelabs.rigclient.protocol.types.ExtensionMapper
     ...
     * 
     */
    private static final long serialVersionUID = -3432883034316245171L;
            ...
            throws javax.xml.stream.XMLStreamException
    {
        ...
        if (prefix == null)
        {
            prefix = NotificationRequestType.generatePrefix(namespace);
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
    {
        ...
        if (namespacePrefix != null && namespacePrefix.trim().length() > 0)
        {
            this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                    + ":NotificationRequestType", xmlWriter);
        }
        else
        {
            this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NotificationRequestType",
                    xmlWriter);
        }
